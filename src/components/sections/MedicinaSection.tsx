      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex justify-center mb-6">
            <span className="inline-flex items-center gap-2 bg-a1pink/10 border border-a1pink/30 text-a1pink px-5 py-2 rounded-full text-sm font-semibold uppercase tracking-wider">
